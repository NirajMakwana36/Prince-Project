                ...
                <div class="product-grid">
                    ...
                    <div class="product-card" onclick="window.location.href='product-detail.php?id=<?php echo $product['id']; ?>'">
                        ...
                        <div class="product-info">
                            ...
                            <?php else: ?>
                                <button class="btn btn-primary" style="width: 100%; height: 40px; padding: 0; border-radius: 8px; opacity: 0.5; cursor: not-allowed; background: var(--border); color: var(--text-muted);" disabled onclick="event.stopPropagation();">
                                    Out of Stock
                                </button>
                            <?php endif; ?>
                        </div>
